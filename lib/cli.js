...
const outLICProps = (LICProps) => console.log(`${Chalk.green('#LIC Properties')}
  license: ${Chalk.yellow(LICProps.license)}
  owner: ${Chalk.green(LICProps.owner)}
  beginYear: ${Chalk.green(LICProps.beginYear)}
  endYear: ${Chalk.green(LICProps.endYear)}
  baseDir: ${Chalk.green(LICProps.baseDir)}
`);

// ::  CLI Process  ::

console.log(`\n::  ${Chalk.cyan('CIX-LIC')}  ::\n`);
outLICProps(LICProps);
