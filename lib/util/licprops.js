...
const LICProps = (v = {}) => {
  ...
  props.licFile = props.licFile ? AppEnv.Util.resolveFile(props.licFile) : undefined;
  props.licenseFile = props.licenseFile ? AppEnv.Util.resolveFile(props.licenseFile) : undefined;
